# File:    random_forest_pca.py
# Purpose: Baseline Random Forest classifier trained on PCA-reduced CICIDS2017 features.
#          Used to compare against metaheuristic feature selection on the same PCA inputs.
