# File:    genetic_algorithm_pca.py
# Purpose: Genetic Algorithm feature selection applied to PCA-reduced CICIDS2017 features.
...
# Output:  Per-generation validation F1, final test metrics, selected PCA component indices.
#          Optional: per-config wandb runs under project "cicids-ga".
#
# GA overview:
