# File:    simulated_annealing_pca.py
# Purpose: Simulated Annealing feature selection applied to PCA-reduced CICIDS2017 features.
#          Starts from a random PCA component subset and explores neighbours with controlled
...
#          Optional: per-config wandb runs under project "cicids-sa".
#
# SA overview:
...
SA_CONFIGS = [
    {"name": "SA_temp20_cool095_flip1", "initial_temp": 2.0, "cooling_rate": 0.95, "flip_bits": 1},
    {"name": "SA_temp20_cool090_flip1", "initial_temp": 2.0, "cooling_rate": 0.90, "flip_bits": 1},
    {"name": "SA_temp20_cool095_flip2", "initial_temp": 2.0, "cooling_rate": 0.95, "flip_bits": 2},
    {"name": "SA_temp50_cool095_flip1", "initial_temp": 5.0, "cooling_rate": 0.95, "flip_bits": 1},
    {"name": "SA_temp50_cool090_flip1", "initial_temp": 5.0, "cooling_rate": 0.90, "flip_bits": 1},
    {"name": "SA_temp50_cool095_flip2", "initial_temp": 5.0, "cooling_rate": 0.95, "flip_bits": 2},
]
